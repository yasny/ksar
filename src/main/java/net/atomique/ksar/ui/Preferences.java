...
public class Preferences extends javax.swing.JDialog {
  ...
  private void load_fonts() {
	  ...
	  for (String name : fontFamilyNames) {
		  FontComboBox.addElement(name);
	  }
	  FontComboBox.setSelectedItem(Config.getGraphFont().getFontName());
  }
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jPanel11.setPreferredSize(new java.awt.Dimension(208, 37));
        jPanel11.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        jLabel8.setText("Graph Font:");
        jPanel11.add(jLabel8);

        jComboBox4.setModel(FontComboBox);
        ...
        jCheckBox1.setSelected(Config.getUseHostnameInGraphTitle());
        jCheckBox1.setText("Use Hostname in Graph Title");
  ...
  private void OkButtonActionPerformed(
	...
	Config.setGraphFont(jComboBox4.getSelectedItem().toString(), Config.DEFAULT_FONT_STYLE, Config.DEFAULT_FONT_SIZE);
	Config.setUseHostnameInGraphTitle(jCheckBox1.isSelected());
    Config.save();
    dispose();
  ...
  DefaultComboBoxModel FontComboBox = new DefaultComboBoxModel();
