...
public class DataView extends javax.swing.JInternalFrame {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        PNGMenu = new javax.swing.JMenuItem();
        ...
        PNGMenu.setText("Export to PNG...");
        PNGMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void jButton1ActionPerformed(
    ...
    private void PNGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PNGActionPerformed
		...
		tmp = null;
		String exportDirPath = askSaveDirectory("Export PNG", Config.getLastExportDirectory());
		if (exportDirPath == null)
			return;
		log.debug("Saving PNGs to {}", exportDirPath);
		doExportPNG(exportDirPath);
    }//GEN-LAST:event_PNGActionPerformed

	private String askSaveDirectory(String title, File lastDirectory) {
		String dirName = null;
		...
		if (chooser.showSaveDialog(GlobalOptions.getUI()) == JFileChooser.APPROVE_OPTION) {
			//dirName = chooser.getCurrentDirectory().getAbsolutePath();
  ...
  public void doExportPNG(String exportDirPath) {
	  int fileCount = mysar.get_page_to_print();
	  JPanel panel0 = new JPanel();
	  JPanel panel1 = new JPanel();
	  JPanel panel2 = new JPanel();
	  ...
	  JProgressBar pbar = new JProgressBar();
	  pbar.setMinimum(0);
	  pbar.setMaximum(fileCount);
	  pbar.setStringPainted(true);

	  JLabel title = new JLabel("Exporting: ");
	  ...
	  dlg.setContentPane(panel0);
	  dlg.setSize(250, 80);
	  dlg.pack();
	  dlg.setLocationRelativeTo(GlobalOptions.getUI());
	  dlg.setVisible(true);
	  
	  Thread th = new Thread(new FilePNG(exportDirPath, mysar, pbar, dlg));
	  th.start();
  }
  ...
  private void save_data() {
    ...
    private javax.swing.JMenuItem PNGMenu;
